...
class UserManager(IntegerIDMixin, BaseUserManager[DefaultUser, int]):
    reset_password_token_secret = SECRET_AUTH
    verification_token_secret = SECRET_AUTH

    async def on_after_register(self, user: DefaultUser, request: Optional[Request] = None):
